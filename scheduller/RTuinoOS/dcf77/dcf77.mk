...
# Does this sample require the floating point support for the standard I/O library (printf in
# the first place)?
IO_FLOAT_LIB = 0
ifeq ($(IO_FLOAT_LIB),1)
    $(info dcf77.mk: This application makes use of the stdio library with floating point support for printf & co)
endif
...
$(warning dcf77.mk: This test case uses a Baud rate of 115200 bps for communication. \
