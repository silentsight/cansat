...
# the first place).
IO_FLOAT_LIB = 1
$(info tc14_dcf.mk: tc14_dcf makes use of the stdio library with floating point support for printf & co)
...
srcDirList += code/applications/tc14_dcf/rtosConfig/ code/applications/tc14_dcf/applCode/
$(info tc14_dcf.mk: Customized list of source folders for tc14_dcf: $(srcDirList))
