...
/**
 * @file tc14_dcf/applCode/clk_clock.h
...
/** Callback, which notifies new time information from the DCF task. */
void clk_onNewDcfTelegram(const dcf_timeInfo * const pTimeInfo);
